...
| Clickable file anchors (Markdown link for chat UI, backticked path for terminal code-walks, spaces wrapping, no ranges/`file://`) | `/Users/toale/Developer/biot-awesome-skills/instructions/clickable-file-anchors.md` | Before emitting any file reference the user is meant to click |
